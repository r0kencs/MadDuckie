...
mask_ym_image = cv2.bitwise_and(gray, mask_ym)

#cv2.imshow("edges", edges)

#cv2.imshow("mask_ym_image", mask_ym_image)
...
lines = cv2.HoughLinesP(region_image, rho=2, theta=np.pi/180, threshold=100, minLineLength=40, maxLineGap=5)
for line in lines:
    x1, x2, y1, y2 = line[0]
